...
var __toESM = (mod, isNodeMode, target) => (
    (target = mod != null ? __create(__getProtoOf(mod)) : {}), __copyProps(isNodeMode || !mod || !mod.__esModule ? __defProp(target, 'default', { value: mod, enumerable: true }) : target, mod)
);
        ...
        module2.exports = function (jwtString, secretOrPublicKey, options, callback) {
            ...
            return getSecret(header, function (err, secretOrPublicKey2) {
                ...
                if (!options.algorithms) {
                    options.algorithms =
                        ~secretOrPublicKey2.toString().indexOf('BEGIN CERTIFICATE') || ~secretOrPublicKey2.toString().indexOf('BEGIN PUBLIC KEY')
                            ? PUB_KEY_ALGS
...
// services/TokenService/Lambdas/lambdaJWTAuthorizer.ts
var lambdaJWTAuthorizer_exports = {};
__export(lambdaJWTAuthorizer_exports, {
    LambdaJWTAuthorizerHandler: () => LambdaJWTAuthorizerHandler
});
module.exports = __toCommonJS(lambdaJWTAuthorizer_exports);

// services/TokenService/utils/AWSPolicyGenerator.ts
var AWSPolicyGenerator = class {
...
async function ValidateTokenFromCookies(event) {
    ...
    if (tokensFromCookies.refreshToken == void 0 || tokensFromCookies.refreshToken == '') {
        ...
        try {
            const decoded = jwt2.verify(tokensFromCookies.refreshToken, process.env.hashSalt, {
                algorithms: ['HS256']
            });
        } catch (error) {
    ...
    if (accessIdentity.accessToken == void 0 || accessIdentity.accessToken == '') {
        ...
        try {
            const decoded = jwt2.verify(accessIdentity.accessToken, process.env.hashSalt, {
                algorithms: ['HS256']
            });
...
// services/TokenService/Lambdas/lambdaJWTAuthorizer.ts
async function LambdaJWTAuthorizerHandler(event, context, callback) {
