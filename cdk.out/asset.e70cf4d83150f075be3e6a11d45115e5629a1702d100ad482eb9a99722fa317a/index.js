...
// services/RegisterBot/getBot.ts
var getBot_exports = {};
__export(getBot_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(getBot_exports);
...
async function handler(event, context) {
  ...
  if (event.queryStringParameters && "botToken" in event.queryStringParameters) {
    ...
    const registrationUrl = "https://api.telegram.org/bot" + keyValue + "/getMe";
    const response = await import_axios.default.get(registrationUrl);
