...
export function CreateUserSubscriptionPlansLambdas(that: any, rootResource: apigateway.Resource, layers: ILayerVersion[], tables: ITable[]) {
    ...
    const GetSubscriptionPlanLambda = new NodejsFunction(that, 'GetSubscriptionPlanLambda', {
        entry: join(__dirname, '..', '..', '..', 'services', 'UserSubscriptionPlans', 'GetSubscriptionPlanLambda.ts'),
    ...
    const AddSubscriptionPlanLambda = new NodejsFunction(that, 'AddSubscriptionPlanLambda', {
        entry: join(__dirname, '..', '..', '..', 'services', 'UserSubscriptionPlans', 'AddSubscriptionPlanLambda.ts'),
    ...
    const EditSubscriptionPlanLambda = new NodejsFunction(that, 'EditSubscriptionPlanLambda', {
        entry: join(__dirname, '..', '..', '..', 'services', 'UserSubscriptionPlans', 'EditSubscriptionPlanLambda.ts'),
    ...
    const DeleteSubscriptionPlanLambda = new NodejsFunction(that, 'DeleteSubscriptionPlanLambda', {
        entry: join(__dirname, '..', '..', '..', 'services', 'UserSubscriptionPlans', 'DeleteSubscriptionPlanLambda.ts'),
